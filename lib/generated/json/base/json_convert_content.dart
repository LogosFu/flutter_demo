...
import 'package:flutterdemo/generated/json/belle_info_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case BelleInfoEntity:
			return belleInfoEntityFromJson(data as BelleInfoEntity, json) as T;			case BelleInfoData:
			return belleInfoDataFromJson(data as BelleInfoData, json) as T;			case AndroidInfoEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case BelleInfoEntity:
			return belleInfoEntityToJson(data as BelleInfoEntity);			case BelleInfoData:
			return belleInfoDataToJson(data as BelleInfoData);			case AndroidInfoEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'BelleInfoEntity':
			return BelleInfoEntity().fromJson(json);			case 'BelleInfoData':
			return BelleInfoData().fromJson(json);			case 'AndroidInfoEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'BelleInfoEntity':
			return List<BelleInfoEntity>();			case 'BelleInfoData':
			return List<BelleInfoData>();			case 'AndroidInfoEntity':
