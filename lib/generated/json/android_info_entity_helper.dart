...
androidInfoEntityFromJson(AndroidInfoEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new List<AndroidInfoData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new AndroidInfoData().fromJson(v));
		});
	}
	if (json['page'] != null) {
...
Map<String, dynamic> androidInfoEntityToJson(AndroidInfoEntity entity) {
...
androidInfoDataFromJson(AndroidInfoData data, Map<String, dynamic> json) {
	if (json['_id'] != null) {
...
Map<String, dynamic> androidInfoDataToJson(AndroidInfoData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['_id'] = entity.sId;
